...
Java提供了经典信号量（[Semaphore][Semaphore 1]）的实现，它通过控制一定数量的允许（permit）的方式，来达到限制通用资源访问的目的。你可以想象一下这个场景，在车站、机场等出租车时，当很多空出租车就位时，为防止过度拥挤，调度员指挥排队等待坐车的队伍一次进来5个人上车，等这5个人坐车出发，再放进去下一批，这和Semaphore的工作原理有些类似。
...
![46c88c7d8e0507465bddb677e4eac5b9.png][]
...
![eff56d3219ce5493ecacc70a168b2b9f.png][]

Java并发类库还提供了[Phaser][]，功能与CountDownLatch很接近，但是它允许线程动态地注册到Phaser上面，而CountDownLatch显然是不能动态设置的。Phaser的设计初衷是，实现多个线程类似步骤、阶段场景的协调，线程注册等待屏障条件触发，进而协调彼此间行动，具体请参考这个[例子][Link 1]。

接下来，我来梳理下并发包里提供的线程安全Map、List和Set。首先，请参考下面的类图。

![35390aa8a6e6f9c92fda086a1b95b457.png][]
...
![63b94b5b1d002bb191c75d2c48af767b.png][]
...
[CountDownLatch]: https://docs.oracle.com/javase/9/docs/api/java/util/concurrent/CountDownLatch.html
[CyclicBarrier]: https://docs.oracle.com/javase/9/docs/api/java/util/concurrent/CyclicBarrier.html
[Semaphore]: https://docs.oracle.com/javase/9/docs/api/java/util/concurrent/Semaphore.html
[Semaphore 1]: https://en.wikipedia.org/wiki/Semaphore_%28programming%29
[46c88c7d8e0507465bddb677e4eac5b9.png]: https://static001.geekbang.org/resource/image/46/b9/46c88c7d8e0507465bddb677e4eac5b9.png
[eff56d3219ce5493ecacc70a168b2b9f.png]: https://static001.geekbang.org/resource/image/ef/9f/eff56d3219ce5493ecacc70a168b2b9f.png
[Phaser]: https://docs.oracle.com/javase/9/docs/api/java/util/concurrent/Phaser.html
[Link 1]: http://www.baeldung.com/java-phaser
[35390aa8a6e6f9c92fda086a1b95b457.png]: https://static001.geekbang.org/resource/image/35/57/35390aa8a6e6f9c92fda086a1b95b457.png
[63b94b5b1d002bb191c75d2c48af767b.png]: https://static001.geekbang.org/resource/image/63/7b/63b94b5b1d002bb191c75d2c48af767b.png
